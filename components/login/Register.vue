<template>
  <div>
    ...
    >
      <input id="email" v-model="username" name="email" type="text" class="textbox1 textbox1_50 title_box_short" placeholder="Email *">
      <input id="password" v-model="password" name="password" type="password" class="textbox1 textbox1_50 title_box_short" placeholder="******">
    ...
    async handleSubmit() {
      ...
      if (username && password) {
        try {
          ...
          // this.$set(this.status, "loggingIn", false)
